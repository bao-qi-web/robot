...
(function (global) {
  ...
  icon: 'fa-robot',
  statBadge: '10',
  hubBlurb: '按产业角色浏览工业、协作、医疗、农业、建筑等全品类',
  intro: '从工业机器人到服务、特种、协作、农业、建筑等类型，覆盖制造、医疗、农业、建筑、物流等全产业赛道，是认识机器人谱系的入口。',
  items: [
  ...
  icon: 'fa-microchip',
  statBadge: '320+',
  hubBlurb: '伺服、传动、控制、感知、执行、安全等全链条关键模块',
  intro: '伺服、减速器、控制器、感知、执行与安全模块构成机器人的「筋骨、感官与大脑」，是国产技术突破的核心关键环节。',
  items: [
  ...
  icon: 'fa-shoe-prints',
  statBadge: '10',
  hubBlurb: '全地形全场景移动构型：轮履足飞壁轨等',
  intro: '轮式、履带、足式、飞行、爬壁、轨道等多种移动构型，决定了机器人的适用地形、作业场景与任务边界。',
  items: [
  ...
  icon: 'fa-flask',
  statBadge: '16',
  hubBlurb: '国家级科研平台与核心研究方向全导读',
  intro: '国家级科研平台承担机器人基础理论、关键共性技术与产业转化攻关，是我国机器人产业创新的核心源头与技术底座。',
  items: [
  ...
  icon: 'fa-lightbulb',
  statBadge: '20',
  hubBlurb: '冷知识、行业轶事、顶级赛事与前沿概念全收录',
  intro: '从词汇起源到产业里程碑、从顶级赛事到前沿技术，用轻松有趣的条目，带你解锁机器人不为人知的另一面。',
  items: [
  ...
  var CATEGORY_TO_TOPIC_FILE = {
    ...
    发展阶段: '../发展阶段/发展阶段.html',
    应用场景: '../应用场景/应用场景.html',
    国产机器人明星: '../国产机器人明星/国产机器人明星.html',
    核心零部件: '../核心零部件/核心零部件.html',
    行动方式种类: '../行动方式种类/行动方式种类.html',
    专利数量: '../专利数量/专利数量.html',
    国家级实验室: '../国家级实验室/国家级实验室.html',
    有趣知识: '../有趣知识/有趣知识.html'
  };

  var TOPIC_KEY_TO_FILE = {
    'topic-main-types': '../主要种类/主要种类.html',
    'topic-development': '../发展阶段/发展阶段.html',
    'topic-scenarios': '../应用场景/应用场景.html',
    'topic-domestic-stars': '../国产机器人明星/国产机器人明星.html',
    'topic-core-parts': '../核心零部件/核心零部件.html',
    'topic-locomotion': '../行动方式种类/行动方式种类.html',
    'topic-patents': '../专利数量/专利数量.html',
    'topic-labs': '../国家级实验室/国家级实验室.html',
    'topic-fun-facts': '../有趣知识/有趣知识.html'
  };
