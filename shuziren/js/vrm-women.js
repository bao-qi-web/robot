...
function createIntroButton() {
    ...
    background: linear-gradient(135deg, #2a6f97, #1e4f6e) !important;
    ...
    box-shadow: 0 4px 15px rgba(42, 111, 151, 0.3) !important;
...
`;
    ...
    introBtn.onmouseover = () => {
        ...
        introBtn.style.boxShadow = '0 12px 28px rgba(42, 111, 151, 0.6) !important';
    };
    
    introBtn.onmouseout = () => {
        introBtn.style.transform = 'scale(1)';
        introBtn.style.boxShadow = '0 8px 20px rgba(42, 111, 151, 0.4) !important';
    };
