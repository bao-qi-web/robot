const SUPABASE_URL = "https://zoxaarjdtiukqsxqqyow.supabase.co"; // 请替换为你的 Supabase 项目 URL
const SUPABASE_ANON_KEY = "sb_publishable_XtHFRdFxomWZa4SXivxNKg_NtilCbAC"; // 请替换为你的 Supabase Public Anon Key
